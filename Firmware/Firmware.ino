...
#define SND_DETECTOR_PIN_GATE	3
...
void loop() 
{
    ...
    {
    // Disclaimer: The SparkFun Sound Detector is in testing and/or doesn't have code, therefore it may be buggy. Please be kind and report any bugs you may find.
    }
...
char menu()
{
    ...
    Serial.println(F("(3) SparkFun Sound Detector"));
    ...
    while (Serial.available()) 
    {
        ...
        {   
            ...
            if(c == '1') 
    			...
    			Serial.println(F("Now Testing SparkFun Sound Detector - note that this component doesn't have a test code"));
            else
            {
